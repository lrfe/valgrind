...
/*--------------------------------------------------------------------*/
/*-- nanoMIPS/Linux-specific kernel interface  vki-or1k-linux.h --*/
/*--------------------------------------------------------------------*/
...
#ifndef __VKI_OR1K_LINUX_H
#define __VKI_OR1K_LINUX_H

#include <config.h>

#define VKI_BIG_ENDIAN       1

/* or1k uses fixed 8 KiB pages (PAGE_SHIFT == 13). */
#define VKI_PAGE_SHIFT       13
...
struct vki_sigcontext {
   struct vki_user_regs_struct regs;   /* must be first */
   unsigned long oldmask;              /* union with fpcsr in the kernel */
};
