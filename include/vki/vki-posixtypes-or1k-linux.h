/*--------------------------------------------------------------------*/
/*--- or1k/Linux-specific kernel interface: posix types.           ---*/
/*---                                 vki-posixtypes-or1k-linux.h ---*/
/*--------------------------------------------------------------------*/
...
#ifndef __VKI_POSIXTYPES_OR1K_LINUX_H
#define __VKI_POSIXTYPES_OR1K_LINUX_H

/* From the kernel's asm-generic/posix_types.h (or1k uses it verbatim). */
...
#endif // __VKI_POSIXTYPES_OR1K_LINUX_H

/*--------------------------------------------------------------------*/
/*--- end                             vki-posixtypes-or1k-linux.h ---*/
/*--------------------------------------------------------------------*/
